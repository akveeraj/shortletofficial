...
// ----------------------------------------------------------------------------------------------------------------------------------
  ...
  nData = "req:" & Req & ";city:" & City & ";method:" & Method & ";duration:" & Duration & ";total:" & Total & ";" & _
          "desc:" & Desc & ";mobile:" & Mobile & ";countrycode:" & CountryCode & ";txid:" & TxId & ";newtxid:" & NewTxId & ";" & _
		  "subid:" & SubId & ";expirydate:" & ExpiryDate & ";expirydatetime:" & ExpiryDateTime & ";referrer:" & PPUrl & ";email:" & Email
		  
  If nData > "" Then nData = StringToHex( nData ) End If
...
// ----------------------------------------------------------------------------------------------------------------------------------
  ...
  CancelReturn    = "http://" & HostName & "/alertsubpaymentcancelled/subscriptions/?data:" & nData
  ReturnUrl       = "http://" & HostName & "/alertrenewconfirm/checkout/?output:1;data:" & nData
...
document.observe("dom:loaded", function() {
 document.title = "Renew your Alert Service Subscription | Town and Gown Shortlets UK";
 paypalsubmit();
...
<div class='contentheader2'>Renew your Alert Service Subscription</div>
