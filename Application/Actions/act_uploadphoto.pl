...
// ---------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  If FileOK = "0" Then
    UploadFailed = 1
	ResponseCode = 1
	ResponseText = "The photo you are trying to upload is not a valid photo format. Please upload .GIF, .PNG, .JPG, .JPEG files only!"
	Call DeleteFile( DeleteFileSrc )
	
  'ElseIf DimensionsOK = "0" Then
    'UploadFailed = 1
	'ResponseCode = 2
	'ResponseText = "The photo you uploaded is in vertical format. Please upload a landscape photo."
	'Call DeleteFile( DeleteFileSrc )
	
  ElseIf MaxSizeOk = "0" Then
    UploadFailed = 1
	ResponseCode = 3
	ResponseText = "The photo you are uploading is too large.<br/>The uploader has a 30 Megabytes limit"
	Call DeleteFile( DeleteFileSrc )
...
// ---------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  JSOn = "{'rcode':'" & ResponseCode & "', 'rtext':'" & ResponseText & "', 'failed':'" & UploadFailed & "', 'image':'" & NewFileName & "', 'pelement':'" & PElement & "', 'listingid':'" & ListingId & "'}"
  Response.Write JSOn
