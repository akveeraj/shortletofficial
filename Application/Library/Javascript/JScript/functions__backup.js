...
function SavePreviewAdvert( id, completepath, saveaction ) {

  var saveaction   = saveaction;
  
  if ( saveaction == "1" ) {
    var url = "/saveadvertfrompreview/actions/?output:1;"
  } else if ( saveaction == "2" ) {
    var url = "/updatead/checkout/?output:1;"
  }

  var id           = id;
  var completepath = completepath;
  var cpath        = completepath;
  var params       = "rpath:" + completepath + ";id:" + id;
...
function previewadvert() {
  ...
  var photo1vert   = document.getElementById('photo1isvert');
  var photo2vert   = document.getElementById('photo2isvert');
  var photo3vert   = document.getElementById('photo3isvert');
  var photo4vert   = document.getElementById('photo4isvert');
  var photo5vert   = document.getElementById('photo5isvert');
  ...
  var pars5   = "photo1value:" + photo1value + ";photo2value:" + photo2value + ";photo3value:" + photo3value + ";photo4value:" + photo4value + ";photo5value:" + photo5value + ";";
  var pars6   = "photo1isvert: "+ photo1isvert.value + ";photo2isvert: " + photo2isvert.value + ";photo3isvert:" + photo3isvert.value + ";photo4isvert:" + photo4isvert.value + ";photo5isvert:" + photo5isvert.value + ";";
  var pars7   = "photo1width:" + photo1width.value + ";photo2width:" + photo2width.value + ";photo3width:" + photo3width.value + ";photo4width:" + photo4width.value + ";photo5width:" + photo5width.value + ";";
...
function processpreviewadvert(rtext) {
  ...
  if ( rcode < 16 ) {
    ...
    if ( saveaction == "1" ) {
	 ...
	 document.location.href = "/previewadvert/account/?rpath:" + rpath;
	
	} else if ( saveaction == "2" ) {
	  
	  if ( fromlive == "1" ) {
	    document.location.href = "/previeweditadvert/account/?listingid:" + listingid + ";rpath:" + rpath + ";fromlive:" + fromlive;
	  } else if ( fromsaved == "1" ) {
	    document.location.href = "/previeweditadvert/account/?listingid:" + listingid + ";rpath:" + rpath + ";fromsaved:" + fromsaved;
	  } else if ( fromexpired == "1" ) {
	    document.location.href = "/previeweditadvert/account/?listingid:" + listingid + ";rpath:" + rpath + ";fromexpired:" + fromexpired;
	  } else if ( fromdeleted == "1" ) {
	    document.location.href = "/previeweditadvert/account/?listingid:" + listingid + ";rpath:" + rpath + ";fromdeleted:" + fromdeleted;
	  } else {
	    document.location.href = "/previeweditadvert/account/?listingid:" + listingid + ";rpath:" + rpath;
	  }
...
function DeleteUploadPhoto(photoid, photonumber, holder, deletebutton, uploadfile, listingid, page, fromedit ){
  ...
  var url           = "/deleteuploadphoto/actions/?output:1;";
  
  var params        = "photoid:" + photoid + ";photo1src:" + photo1src + ";photo2src:" + photo2src + ";photo3src:" + photo3src + ";photo4src:" + photo4src + ";photo5src:" + photo5src + ";" +
...
function ProcessDeleteUploadPhoto(rtext) {
  ...
  //JSOn = "{'photonumber':'" & PhotoNumber & "', 'holder':'" & Holder & "', 'deletebutton':'" & DeleteButton & "', 'uploadfile':'" & UploadFile & "'}"
}
...
function ProcessResetPassword(rtext) {
  ...
  var rpath      = json.rpath;
  var eurl       = "/alert/alerts/?output:1;"
  var surl       = "/notifynobutton/alerts/?output:1;responsetext:Your password has been sent to your registered email address;pagetitle:Reminder Sent";
