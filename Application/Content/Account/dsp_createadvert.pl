...
// ---------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  If Edit = "1" Then
	...
	If AdReferences  > "" Then AdReferences  = Replace( AdReferences, "%0A", vbcrlf )
  ...
  Else 
	...
	Photo6Html = "<img src='/uploads/thumbs/nopicsmall.png' id='photo6img'/>"
...
document.observe("dom:loaded", function() {
  ...
  //var locationdrop = document.getElementById('location');
  //var location = "<%=Location%>";
  //if ( location > "" ) {
  //   locationdrop.value = location;
  //} else {
  //  locationdrop.value  = "-"
  //}
...
<div class='createad_justregistered' style='margin-top:20px;'>
  ...
  <br/>A confirmation message has been sent to your registered Email Address containing
   your log in details.
</div>
<% End If %> 

<div class='textblock' style='margin-bottom:40px; margin-top:20px; border-bottom:solid 1px #eeeeee; text-align:center;'>
...
<span class='spacer'></span>
  ...
  <div class='row'>
	...
	<span class='cell'><input type='text' name='title' id='title' value='<%=AdTitle%>' autocomplete='off' placeholder='Required Field - 200 Characters maximum' class='input' onkeyup="limiter('title', '200', 'titlecount')" maxlength="200"/></span>
  </div>
