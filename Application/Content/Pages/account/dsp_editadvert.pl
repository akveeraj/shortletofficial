...
<div class='textblock' style='text-align:center;'><b>Use the form below to update your advert.</b><br/>Click the Preview Advert to preview and save your advert.<br/><br/></div>
...
<span class='spacer'></span>
  ...
  <div class='row'>
	...
	<span class='cell'><input type='text' name='title' id='title' value='' autocomplete='off' placeholder='Required Field - 90 Characters maximum' class='input' onkeyup="limiter('title', '90', 'titlecount')" maxlength="90"/></span>
  </div>
...
<span class='cell'><span class='label'>Postcode</span></span>
  ...
  <div class='row'>
    <textarea class='textarealarge' name='description' id='description' autocomplete='off' placeholder='3000 characters maximum - No HTML or code' onkeyup="limiter('description', '3000', 'descriptioncount')" maxlength="3000"><%=AdDescription%></textarea>
  </div>
