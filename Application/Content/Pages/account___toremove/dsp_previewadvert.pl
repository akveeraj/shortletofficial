...
<span class='smalltext'>Standard adverts are displayed in the date order they are published sdfsdfsdf</span>
</div>
...
<div class='preview_adoptions'>
  <div class='row'>
	...
	<span class='cell' style='float:right;'>
	  ...
	  <span class='save' id='previewbutton'><a href='javascript://' onclick="CreateNewAd('<%=CompPath%>')">Place Advert Now &gt;</a></span>
	  <span class='wait' id='previewwait'></span>
	</span>
